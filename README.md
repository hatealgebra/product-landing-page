...
Optimize images, either with sizes and srcset if there would be possiblity to have multiple sources of the image. Also good idea would be adding the webp with the fallback to the png or jpg
